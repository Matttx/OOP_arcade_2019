...
emulator::Game::Game(engine::ecs::Universe& universe) : game::AGame("emulator", universe)
{
}
...
void emulator::Game::initMusic(engine::ecs::World& mainWorld)
{
    const std::vector<std::string> paths = {
        "./assets/emulator/music.txt", "./assets/emulator/music.wav", "./assets/emulator/music.debug"};
...
{
    const std::vector<std::string> paths = {
        "./assets/emulator/background.txt", "./assets/emulator/background.png", "./assets/emulator/background.debug"};
    ...
    background.addComponent<engine::component::Transform>(engine::type::Vector2D {0, 0}, 0);
}

void emulator::Game::initTitle(engine::ecs::World& mainWorld)
{
    const std::vector<std::string> paths = {
        "./assets/emulator/arcade.txt", "./assets/emulator/arcade-animate.png", "./assets/emulator/arcade.debug"};
    const std::map<std::string, engine::type::Animation> list {{"default", engine::type::Animation(0, 5, 100)}};

    auto& title = mainWorld.createEntity();

    title.addComponent<engine::component::Animations>(list);
    title.getComponent<engine::component::Animations>().currentAnimation = "default";
    ...
    title.addComponent<engine::component::Transform>(engine::type::Vector2D {667, 50}, 10);
}

void emulator::Game::initControls(engine::ecs::World& mainWorld)
{
    const std::vector<std::string> exitPaths = {
        "./assets/emulator/exit.txt", "./assets/emulator/exit.png", "./assets/emulator/exit.debug"};
    const std::vector<std::string> previousPaths = {
        "./assets/emulator/previous.txt", "./assets/emulator/previous.png", "./assets/emulator/previous.debug"};
    const std::vector<std::string> confirmPaths = {
        "./assets/emulator/confirm.txt", "./assets/emulator/confirm.png", "./assets/emulator/confirm.debug"};
    ...
    exit.addComponent<engine::component::Transform>(engine::type::Vector2D {20, 20}, 10);
    ...
    previous.addComponent<engine::component::Transform>(engine::type::Vector2D {20, 1080 - 98 - 20}, 10);
    ...
    confirm.addComponent<engine::component::Transform>(engine::type::Vector2D {1920 - 392 - 20, 1080 - 98 - 20}, 10);
}

void emulator::Game::initGraphicalMenu(engine::ecs::World& mainWorld)
{
    const std::vector<std::string> framePaths = {
        "./assets/emulator/graphical.txt", "./assets/emulator/graphical.png", "./assets/emulator/graphical.debug"};
    const std::vector<std::string> buttonPaths = {
        "./assets/emulator/button.txt", "./assets/emulator/button.png", "./assets/emulator/button.debug"};
    const std::vector<std::string> fontPaths = {
        "./assets/emulator/font.txt", "./assets/emulator/font.ttf", "./assets/emulator/font.debug"};
    ...
    frame.addComponent<engine::component::Transform>(engine::type::Vector2D {71, 240}, 10);
    ...
    for (const auto& graphicalName : graphicalNames) {
        ...
        button.addComponent<emulator::component::Action>([&mainWorld, graphicalName](engine::ecs::Universe& universe) {
        ...
        button.addComponent<engine::component::Transform>(engine::type::Vector2D {71 + 150, 240 + 170 + 150 * i}, 20);
        mainWorld.addToGroup(button, "graphicals");

        int textWidth = 40 * graphicalName.second.size();
        int textHeight = 50;

        text.addComponent<engine::component::AText>(graphicalName.second, fontPaths);
        text.addComponent<engine::component::Size>(textWidth, textHeight);
        text.addComponent<engine::component::Transform>(
            engine::type::Vector2D {71 + 150 + ((518 - textWidth) / 2), 240 + 170 + 30 + 150 * i}, 30);
...
{
    const std::vector<std::string> framePaths = {
        "./assets/emulator/game.txt", "./assets/emulator/game.png", "./assets/emulator/game.debug"};
    const std::vector<std::string> buttonPaths = {
        "./assets/emulator/button.txt", "./assets/emulator/button.png", "./assets/emulator/button.debug"};
    const std::vector<std::string> fontPaths = {
        "./assets/emulator/font.txt", "./assets/emulator/font.ttf", "./assets/emulator/font.debug"};
    ...
    frame.addComponent<engine::component::ARender>(framePaths);
    frame.addComponent<engine::component::Size>(818, 666);
    frame.addComponent<engine::component::Transform>(engine::type::Vector2D {1031, 240}, 10);
    ...
    for (const auto& gameName : gameNames) {
        ...
        button.addComponent<emulator::component::Action>([gameName](engine::ecs::Universe& universe) {
            universe.getCore().setCurrentGame(gameName.first);
        });
        button.addComponent<engine::component::ARender>(buttonPaths);
        button.addComponent<engine::component::Size>(518, 136);
        button.addComponent<engine::component::Transform>(engine::type::Vector2D {1031 + 150, 240 + 170 + 150 * i}, 20);
        ...
        text.addComponent<engine::component::Size>(textWidth, textHeight);
        text.addComponent<engine::component::Transform>(
            engine::type::Vector2D {1031 + 150 + ((518 - textWidth) / 2), 240 + 170 + 30 + 150 * i}, 30);
...
{
    const std::vector<std::string> paths = {
        "./assets/emulator/selector.txt", "./assets/emulator/selector.png", "./assets/emulator/selector.debug"};
    ...
    selector.addComponent<engine::component::Transform>(engine::type::Vector2D {0, 0}, 20);
}

...
void game::emulator::Game::init()
{
    ...
    gameBtn1.addComponent<game::emulator::component::Action>(
        [](engine::ecs::Universe& universe) {
            std::cout << "gameBtn1 callback!" << std::endl;
            universe.getCore().setCurrentGraphical("lib_arcade_sdl.so");
        });
    ...
    gameBtn2.addComponent<game::emulator::component::Action>(
        [](engine::ecs::Universe& universe) {
            (void)universe;
            std::cout << "gameBtn2 callback!" << std::endl;
          universe.getCore().setCurrentGraphical("lib_arcade_sfml.so");
        });
    ...
    graphicalBtn1.addComponent<game::emulator::component::Action>(
        [](engine::ecs::Universe& universe) {
            (void)universe;
    ...
    graphicalBtn2.addComponent<game::emulator::component::Action>(
        [](engine::ecs::Universe& universe) {
            (void)universe;
    ...
    graphicalBtn3.addComponent<game::emulator::component::Action>(
        [](engine::ecs::Universe& universe) {
            (void)universe;

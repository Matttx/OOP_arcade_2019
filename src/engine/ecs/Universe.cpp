...
void engine::ecs::Universe::init()
{
    if (this->_worlds.count(this->_current) == 0)
        throw util::Error("engine::ecs::Universe::init()", "The world '" + this->_current + "' doesn't exist");
...
{
    if (this->_worlds.count(this->_current) == 0)
        throw util::Error("engine::ecs::Universe::update()", "The world '" + this->_current + "' doesn't exist");
...
{
    if (this->_worlds.count(this->_current) == 0)
        throw util::Error("engine::ecs::Universe::render()", "The world '" + this->_current + "' doesn't exist");
...
engine::ecs::World& engine::ecs::Universe::getWorld(const std::string& name) const
{
    if (this->_worlds.count(name) == 0)
        throw util::Error("engine::ecs::Universe::getWorld()", "The world '" + this->_current + "' doesn't exist");
...
engine::ecs::World& engine::ecs::Universe::getCurrentWorld() const
{
    if (this->_worlds.count(this->_current) == 0)
        throw util::Error(
            "engine::ecs::Universe::getCurrentWorld()", "The world '" + this->_current + "' doesn't exist");
...
void engine::ecs::Universe::setCurrentWorld(const std::string& name)
{
    if (this->_worlds.count(name) == 0)
        throw util::Error(
            "engine::ecs::Universe::setCurrentWorld()", "The world '" + this->_current + "' doesn't exist");
...
{
    if (this->_worlds.count(name) == 0)
        throw util::Error("engine::ecs::Universe::deleteWorld()", "The world '" + this->_current + "' doesn't exist");
